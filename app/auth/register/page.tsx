...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm rounded-2xl shadow-sm border border-gray-100 p-8 space-y-6 bg-white">
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-bold text-gray-900">Register</h1>
          <p className="text-sm text-gray-500">নতুন অ্যাকাউন্ট তৈরি করো</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <input
            ...
            required
            className="w-full px-4 py-2.5 border text-black border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all text-sm"
          />
          ...
          <input
            ...
            required
            minLength={6}
            className="w-full px-4 py-2.5 text-black border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all text-sm"
          />
